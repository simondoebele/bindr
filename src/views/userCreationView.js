function UserCreationView(props){
    ...
    <div class ="create">
        ...
        <div class = "loginProperties">
            ...
            <div>
                <button onClick = {function(){ window.location.hash = "#pick"; props.signUp(document.getElementById("createUsername").value, document.getElementById("createPassword").value) }}>Create</button>
