...
describe("TW1.1 dishType", function tw1_1_10() {
    ...
    it("dishType returns empty string if starter, main course, dessert not present", function tw1_1_10_3(){ assert.equal(dishType(dishesConst[0]), "");});
    it("dishType returns empty string if dishTypes property not present", function  tw1_1_10_4(){ assert.equal(dishType(dishesConst[7]), "");});
});
